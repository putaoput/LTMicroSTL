	...
	namespace test
	{
		namespace unordered_set_test
		{
			...
			void unordered_set_test()
			{
				...
				int a[] = { 5,4,3,2,1 };
				LT::unordered_set<int> us1;
				LT::unordered_set<int> us2(520);
				LT::unordered_set<int> us3(520, LT::hash<int>());
				LT::unordered_set<int> us4(520, LT::hash<int>(), LT::equal_to<int>());
				LT::unordered_set<int> us5(a, a + 5);
				LT::unordered_set<int> us6(a, a + 5, 100);
				LT::unordered_set<int> us7(a, a + 5, 100, LT::hash<int>());
				LT::unordered_set<int> us8(a, a + 5, 100, LT::hash<int>(), LT::equal_to<int>());
				LT::unordered_set<int> us9(us5);
				LT::unordered_set<int> us10(std::move(us5));
				LT::unordered_set<int> us11;
				us11 = us6;
				LT::unordered_set<int> us12;
				us12 = std::move(us6);
				LT::unordered_set<int> us13{ 1,2,3,4,5 };
				LT::unordered_set<int> us14;
				us13 = { 1,2,3,4,5 };
				...
				//FUN_VALUE(*us1.begin(us1.bucket(1))); 暂时不提供该访问接口
				FUN_VALUE(us1.size());
				FUN_VALUE(us1.bucket_count());
			...
			void unordered_multiset_test()
			{
				...
				std::cout << "[-------------------------- API test ---------------------------]" << std::endl;
				int a[] = { 5,4,3,2,1 };
				LT::unordered_multiset<int> us1;
				LT::unordered_multiset<int> us2(520);
				LT::unordered_multiset<int> us3(520, LT::hash<int>());
				LT::unordered_multiset<int> us4(520, LT::hash<int>(), LT::equal_to<int>());
				LT::unordered_multiset<int> us5(a, a + 5);
				LT::unordered_multiset<int> us6(a, a + 5, 100);
				LT::unordered_multiset<int> us7(a, a + 5, 100, LT::hash<int>());
				LT::unordered_multiset<int> us8(a, a + 5, 100, LT::hash<int>(), LT::equal_to<int>());
				LT::unordered_multiset<int> us9(us5);
				LT::unordered_multiset<int> us10(std::move(us5));
				LT::unordered_multiset<int> us11;
				us11 = us6;
				LT::unordered_multiset<int> us12;
				us12 = std::move(us6);
				LT::unordered_multiset<int> us13{ 1,2,3,4,5 };
				LT::unordered_multiset<int> us14;
				us14 = { 1,2,3,4,5 };
