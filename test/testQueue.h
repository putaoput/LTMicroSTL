...
//            void queue_print(LT::queue<int> q)
//            {
//                while (!q.empty())
//                {
//                    std::cout << " " << q.front();
...
//            }
//
//            void p_queue_print(LT::priority_queue<int> p)
//            {
//                while (!p.empty())
//                {
//                    std::cout << " " << p.top();
...
//} while(0)
            ...
            void queue_test()
            {
                ...
                //LT::queue<int> q2(5);
                //LT::queue<int> q3(5, 1);
                //LT::queue<int> q4(a, a + 5);
                //LT::queue<int> q5(d1);
                //LT::queue<int> q6(std::move(d1));
                //LT::queue<int> q7(q2);
                //LT::queue<int> q8(std::move(q2));
                //LT::queue<int> q9;
                //q9 = q3;
                //LT::queue<int> q10;
                //q10 = std::move(q3);
                //LT::queue<int> q11{ 1,2,3,4,5 };
                //LT::queue<int> q12;
                //q12 = { 1,2,3,4,5 };
//
...
//                int a[] = { 1,2,3,4,5 };
//                LT::vector<int> v1(5);
//                LT::priority_queue<int> p1;
//                LT::priority_queue<int> p2(5);
//                LT::priority_queue<int> p3(5, 1);
//                LT::priority_queue<int> p4(a, a + 5);
//                LT::priority_queue<int> p5(v1);
//                LT::priority_queue<int> p6(std::move(v1));
//                LT::priority_queue<int> p7(p2);
//                LT::priority_queue<int> p8(std::move(p2));
//                LT::priority_queue<int> p9;
//                p9 = p3;
//                LT::priority_queue<int> p10;
//                p10 = std::move(p3);
//                LT::priority_queue<int> p11{ 1,2,3,4,5 };
//                LT::priority_queue<int> p12;
//                p12 = { 1,2,3,4,5 };
//
